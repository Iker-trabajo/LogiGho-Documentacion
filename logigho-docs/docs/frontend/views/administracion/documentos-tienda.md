...
| `FC`, `CB`, `CM`, `CA` | `DocumentInfo | null` | 4 documentos requeridos por delegado |
| `cumplimiento` | `'completo' | 'pendiente' | 'incompleto'` | Completo = 3 docs (FC, CB, CA) y todos validados |
...
| 2026-05-07 | Iker Acevedo Vargas | Se eliminó el campo RUT (`RU`) de las autorizaciones; ahora solo requieren 3 documentos: FC, CB y CA para marcar como completo |
